...
def get_sem_voxel_groups():
    ...
    for si, ss in enumerate(subjects):
        ...
        fitting_type3 = 'alexnet_all_conv_pca'
        out_alexnet = load_fits.load_fit_results(subject=ss, fitting_type=fitting_type3, \
                                                 n_from_end=0, verbose=False)
        ...
        vox_exclude = ~sig_orig | early_visual_mask | \
