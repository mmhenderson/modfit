...
from src.torch_fwrf import learn_params_second_order_pca, get_predictions, get_value, set_value, Torch_fwRF_voxel_block, get_r2, add_nonlinearity, get_features_in_prf_second_order
...
#     lambdas = np.array([0.0,0.0,0.0])
    ...
    best_losses, pc, best_params, second_order_zstats = learn_params_second_order_pca(
        trn_stim_data, trn_voxel_data, _fmaps_fn, models, min_pct_var=min_pct_var, \
    ...
    fn2save = output_dir+'model_params_second_order_pca_%s'%roi2print
