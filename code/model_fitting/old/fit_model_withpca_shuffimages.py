...
from src.torch_fwrf import learn_params_pca, get_predictions, get_value, set_value, Torch_fwRF_voxel_block, get_r2, add_nonlinearity, get_features_in_prf
...
#     lambdas = np.array([0.0,0.0,0.0])
    ...
    fn2save = output_dir+'model_params_pca_shuffimages'
