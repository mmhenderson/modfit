...
# semantic_feature_sets=(all_coco all_coco_categ all_coco_categ_pca coco_things_categ coco_things_categ_pca coco_stuff_categ coco_stuff_categ_pca coco_things_categ_material_diagnostic coco_things_categ_not_material_diagnostic)
